      ...
      <div className="border-t pt-3 mt-3">
        <div className="flex items-center gap-2 mb-2">
          ...
          >
            ...
            <option value="gpt-5.5">ChatGPT (GPT-5.5 — الأقوى)</option>
            <option value="gpt-5.4">ChatGPT (GPT-5.4)</option>
            <option value="gpt-5.4-mini">ChatGPT (GPT-5.4 mini — الأسرع)</option>
